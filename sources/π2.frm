...
Open "c:\windows\ﾃﾞｽｸﾄｯﾌﾟ\pidat\pi atn" & h & ".txt" For Output As 1
For i = 0 To 13 '3999
Print #1, a(i)
Next i
Close #1
...
Open "c:\windows\ﾃﾞｽｸﾄｯﾌﾟ\pidat\pi.txt" For Output As 1
For i = 0 To 13 '3999
Print #1, a(i)
Next i
Close #1
...
t = 45
GoSub skip1
Open "c:\windows\ﾃﾞｽｸﾄｯﾌﾟ\pidat\pi1.txt" For Output As 1
Print #1, "π=" & p(1) & "."
For i = 2 To n9
a2 = p(i)
For l = 1 To 4
