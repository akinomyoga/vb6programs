...
'CommandButton1
Private Sub CommandButton1_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
    Case 16
        btndat = btndat + 1
    Case 17
...
Private Sub CommandButton1_KeyUp(Index As Integer, KeyCode As Integer, Shift As Integer)
    Dim key As Integer
    key = KeyCode
...
Private Sub Form_Load()
    If Dir(CurDir & "\wavdat") <> "" Then
        currentdir = CurDir
    ElseIf Dir("C:\cygwin\home\murase\prog\vs2001\res\âπäy\") <> "" Then
        currentdir = "C:\cygwin\home\murase\prog\vs2001\res\âπäy\"
    ElseIf Dir("C:\Documents and Settings\å˜àÍ\ÉfÉXÉNÉgÉbÉv\é©çÏÉvÉçÉOÉâÉÄ\âπäy\") <> "" Then
...
Public Sub Picture1DRAW()
    For a = HScroll2.Value To HScroll2.Value + 61
        a1 = a - HScroll2.Value
        If a > 9999 Then
